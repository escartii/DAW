CREATE DATABASE  IF NOT EXISTS `instagram_low_cost` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `instagram_low_cost`;
-- MySQL dump 10.13  Distrib 8.0.32, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: instagram_low_cost
-- ------------------------------------------------------
...
CREATE TABLE `comentariosFotos` (
  `idComentarioFoto` int NOT NULL AUTO_INCREMENT,
  `idComentario` int NOT NULL,
  `idFoto` int NOT NULL,
  PRIMARY KEY (`idComentarioFoto`),
  KEY `fk_comentariosFotos_fotos` (`idFoto`),
  KEY `fk_comentariosFotos_comentarios` (`idComentario`),
  CONSTRAINT `fk_comentariosFotos_comentarios` FOREIGN KEY (`idComentario`) REFERENCES `comentarios` (`idComentario`),
  CONSTRAINT `fk_comentariosFotos_fotos` FOREIGN KEY (`idFoto`) REFERENCES `fotos` (`idFoto`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comentariosFotos` VALUES (6,6,6),(7,6,7),(8,6,8),(9,9,8),(10,8,10),(11,11,12);
...
CREATE TABLE `fotos` (
  ...
  CONSTRAINT `fk_fotos_usuarios` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`idUsuario`)
...
INSERT INTO `fotos` VALUES (6,'Una foto de un atardecer en la playa','https://i.imgur.com/t1s42kY.jpg',6,'2024-01-19 23:00:00',836),(7,'Una foto de un plato de comida deliciosa','https://i.imgur.com/a684Y6a.jpg',6,'2024-01-20 23:00:00',272),(8,'Una foto de una montaña nevada','https://i.imgur.com/15X1u7Y.jpg',11,'2024-01-21 23:00:00',467),(9,'Una foto de una pintura abstracta','https://i.imgur.com/4v31516.jpg',4,'2024-01-22 23:00:00',519),(10,'Una foto de un concierto de música rock','https://i.imgur.com/1234567890.jpg',5,'2024-01-23 23:00:00',195),(11,'Paisaje Montañoso','https://ejemplo.com/foto1.jpg',4,'2024-01-26 12:49:06',161),(12,'Atardecer en la Playa','https://ejemplo.com/foto2.jpg',11,'2024-01-26 12:49:06',966),(13,'Ciudad Nocturna','https://ejemplo.com/foto3.jpg',12,'2024-01-26 12:49:06',736),(14,'Retrato en Blanco y Negro','https://ejemplo.com/foto4.jpg',13,'2024-01-26 12:49:06',652),(15,'Aventura en la Naturaleza','https://ejemplo.com/foto5.jpg',16,'2024-01-26 12:49:06',927),(16,'Arquitectura Moderna','https://ejemplo.com/foto6.jpg',19,'2024-01-26 12:49:06',807),(17,'Explorando el Bosque','https://ejemplo.com/foto7.jpg',21,'2024-01-26 12:49:06',256),(18,'Urbanismo Creativo','https://ejemplo.com/foto8.jpg',24,'2024-01-26 12:49:06',475),(19,'Momentos de Reflexión','https://ejemplo.com/foto9.jpg',27,'2024-01-26 12:49:06',609),(20,'Detalles de la Ciudad','https://ejemplo.com/foto10.jpg',60,'2024-01-26 12:49:06',620),(21,'Amanecer en la Ciudad','https://ejemplo.com/foto11.jpg',5,'2024-01-26 12:49:39',275),(22,'Esculturas en el Parque','https://ejemplo.com/foto12.jpg',6,'2024-01-26 12:49:39',257),(23,'Viaje en Tren','https://ejemplo.com/foto13.jpg',14,'2024-01-26 12:49:39',334),(24,'Sesión de Retratos Artísticos','https://ejemplo.com/foto14.jpg',17,'2024-01-26 12:49:39',771),(25,'Aurora Boreal','https://ejemplo.com/foto15.jpg',20,'2024-01-26 12:49:39',985),(26,'Grafitis Urbanos','https://ejemplo.com/foto16.jpg',22,'2024-01-26 12:49:39',741),(27,'Flor en Macro','https://ejemplo.com/foto17.jpg',25,'2024-01-26 12:49:39',624),(28,'Concierto en Vivo','https://ejemplo.com/foto18.jpg',28,'2024-01-26 12:49:39',770),(29,'Caminata por el Bosque','https://ejemplo.com/foto19.jpg',32,'2024-01-26 12:49:39',979),(30,'Reflejos en el Agua','https://ejemplo.com/foto20.jpg',35,'2024-01-26 12:49:39',715),(31,'Cielo Estrellado','https://ejemplo.com/foto21.jpg',38,'2024-01-26 12:49:39',510),(32,'Reunión Familiar','https://ejemplo.com/foto22.jpg',41,'2024-01-26 12:49:39',277),(33,'Rincones Históricos','https://ejemplo.com/foto23.jpg',44,'2024-01-26 12:49:39',601),(34,'Ilustración en la Arena','https://ejemplo.com/foto24.jpg',47,'2024-01-26 12:49:39',302),(35,'Explosión de Colores','https://ejemplo.com/foto25.jpg',50,'2024-01-26 12:49:39',452),(36,'Instante de Felicidad','https://ejemplo.com/foto26.jpg',53,'2024-01-26 12:49:39',355),(37,'Vista desde las Alturas','https://ejemplo.com/foto27.jpg',56,'2024-01-26 12:49:39',291),(38,'Atardecer en el Desierto','https://ejemplo.com/foto28.jpg',59,'2024-01-26 12:49:39',262),(39,'Caminando en la Playa','https://ejemplo.com/foto29.jpg',10,'2024-01-26 12:50:10',312),(40,'Arquitectura Antigua','https://ejemplo.com/foto30.jpg',15,'2024-01-26 12:50:10',644),(41,'Fiesta en la Ciudad','https://ejemplo.com/foto31.jpg',18,'2024-01-26 12:50:10',417),(42,'Refugio en la Montaña','https://ejemplo.com/foto32.jpg',23,'2024-01-26 12:50:10',894),(43,'Atracciones en el Parque de Diversiones','https://ejemplo.com/foto33.jpg',26,'2024-01-26 12:50:10',481),(44,'Desfile de Moda','https://ejemplo.com/foto34.jpg',29,'2024-01-26 12:50:10',465),(45,'Exploración Submarina','https://ejemplo.com/foto35.jpg',33,'2024-01-26 12:50:10',756),(46,'Jardín de Esculturas','https://ejemplo.com/foto36.jpg',36,'2024-01-26 12:50:10',513),(47,'Retrato en Blanco y Negro','https://ejemplo.com/foto37.jpg',39,'2024-01-26 12:50:10',171),(48,'Festival de Luces','https://ejemplo.com/foto38.jpg',42,'2024-01-26 12:50:10',930),(49,'Cascada en la Selva','https://ejemplo.com/foto39.jpg',45,'2024-01-26 12:50:10',528),(50,'Bicicleteada en la Ciudad','https://ejemplo.com/foto40.jpg',48,'2024-01-26 12:50:10',591),(51,'Crepúsculo en el Desierto','https://ejemplo.com/foto41.jpg',51,'2024-01-26 12:50:10',372),(52,'Diversión en el Parque Acuático','https://ejemplo.com/foto42.jpg',54,'2024-01-26 12:50:10',830),(53,'Fuegos Artificiales en la Noche','https://ejemplo.com/foto43.jpg',57,'2024-01-26 12:50:10',296),(54,'Concierto al Aire Libre','https://ejemplo.com/foto44.jpg',60,'2024-01-26 12:50:10',604),(119,'Recorrido en Bicicleta','https://ejemplo.com/foto45.jpg',19,'2024-01-26 12:52:49',262),(120,'Cena Romántica','https://ejemplo.com/foto46.jpg',16,'2024-01-26 12:52:49',242),(121,'Cielo Estrellado en la Montaña','https://ejemplo.com/foto47.jpg',19,'2024-01-26 12:52:49',294),(122,'Descanso en la Hamaca','https://ejemplo.com/foto48.jpg',24,'2024-01-26 12:52:49',620),(123,'Viaje en Globo Aerostático','https://ejemplo.com/foto49.jpg',27,'2024-01-26 12:52:49',345),(124,'Retrato Artístico en Blanco y Negro','https://ejemplo.com/foto50.jpg',30,'2024-01-26 12:52:49',611),(125,'Festival de Cometas','https://ejemplo.com/foto51.jpg',35,'2024-01-26 12:52:49',151),(126,'Aventura Subterránea','https://ejemplo.com/foto52.jpg',38,'2024-01-26 12:52:49',537),(127,'Atardecer en la Playa Desierta','https://ejemplo.com/foto53.jpg',43,'2024-01-26 12:52:49',361),(128,'Jornada de Picnic','https://ejemplo.com/foto54.jpg',46,'2024-01-26 12:52:49',936),(129,'Explorando Ruinas Antiguas','https://ejemplo.com/foto55.jpg',49,'2024-01-26 12:52:49',857),(130,'Festival de Colores','https://ejemplo.com/foto56.jpg',52,'2024-01-26 12:52:49',478),(131,'Caminata en la Selva Tropical','https://ejemplo.com/foto57.jpg',55,'2024-01-26 12:52:49',564),(132,'Instante de Serenidad','https://ejemplo.com/foto58.jpg',58,'2024-01-26 12:52:49',385),(133,'Concierto Acústico','https://ejemplo.com/foto59.jpg',30,'2024-01-26 12:52:49',980),(134,'Mirador en la Montaña','https://ejemplo.com/foto60.jpg',31,'2024-01-26 12:52:49',131),(135,'Aventura en Kayak','https://ejemplo.com/foto61.jpg',11,'2024-01-26 12:54:08',200),(136,'Rascacielos al Atardecer','https://ejemplo.com/foto62.jpg',45,'2024-01-26 12:54:08',482),(137,'Fiesta en la Piscina','https://ejemplo.com/foto63.jpg',28,'2024-01-26 12:54:08',810),(138,'Paseo en Globo al Amanecer','https://ejemplo.com/foto64.jpg',23,'2024-01-26 12:54:08',735),(139,'Espectáculo de Luces en la Ciudad','https://ejemplo.com/foto65.jpg',26,'2024-01-26 12:54:08',248),(140,'Esculturas de Hielo','https://ejemplo.com/foto66.jpg',29,'2024-01-26 12:54:08',650),(141,'Senderismo en la Montaña','https://ejemplo.com/foto67.jpg',33,'2024-01-26 12:54:08',634),(142,'Vista Panorámica de la Ciudad','https://ejemplo.com/foto68.jpg',36,'2024-01-26 12:54:08',223),(143,'Retrato con Explosión de Colores','https://ejemplo.com/foto69.jpg',39,'2024-01-26 12:54:08',829),(144,'Festival de Globos Aerostáticos','https://ejemplo.com/foto70.jpg',42,'2024-01-26 12:54:08',734),(145,'Cascada Congelada','https://ejemplo.com/foto71.jpg',45,'2024-01-26 12:54:08',183),(146,'Cena en la Azotea','https://ejemplo.com/foto72.jpg',48,'2024-01-26 12:54:08',328),(147,'Reflejos en el Lago','https://ejemplo.com/foto73.jpg',51,'2024-01-26 12:54:08',962),(148,'Retrato con Sombras y Luces','https://ejemplo.com/foto74.jpg',54,'2024-01-26 12:54:08',216),(149,'Aventura en Paracaidismo','https://ejemplo.com/foto75.jpg',57,'2024-01-26 12:54:08',680),(150,'Amanecer en la Montaña','https://ejemplo.com/foto76.jpg',60,'2024-01-26 12:54:08',884),(151,'Aventura en Parapente','https://ejemplo.com/foto77.jpg',19,'2024-01-26 12:55:13',508),(152,'Caminata en el Desierto','https://ejemplo.com/foto78.jpg',16,'2024-01-26 12:55:13',630),(153,'Rincón Histórico de la Ciudad','https://ejemplo.com/foto79.jpg',19,'2024-01-26 12:55:13',630),(154,'Descanso en la Hamaca','https://ejemplo.com/foto80.jpg',24,'2024-01-26 12:55:13',263),(155,'Senderismo al Amanecer','https://ejemplo.com/foto81.jpg',27,'2024-01-26 12:55:13',165),(156,'Sesión de Fotos en Estudio','https://ejemplo.com/foto82.jpg',30,'2024-01-26 12:55:13',783),(157,'Esculturas de Arena','https://ejemplo.com/foto83.jpg',35,'2024-01-26 12:55:13',677),(158,'Vista Nocturna desde el Rascacielos','https://ejemplo.com/foto84.jpg',38,'2024-01-26 12:55:13',909),(159,'Retrato Artístico en Sepia','https://ejemplo.com/foto85.jpg',43,'2024-01-26 12:55:13',647),(160,'Festival de Colores en el Cielo','https://ejemplo.com/foto86.jpg',46,'2024-01-26 12:55:13',378),(161,'Exploración en Cuevas','https://ejemplo.com/foto87.jpg',49,'2024-01-26 12:55:13',691),(162,'Picnic en el Jardín Botánico','https://ejemplo.com/foto88.jpg',52,'2024-01-26 12:55:13',455),(163,'Reflejos en el Estanque','https://ejemplo.com/foto89.jpg',55,'2024-01-26 12:55:13',942),(164,'Retrato con Efecto Bokeh','https://ejemplo.com/foto90.jpg',58,'2024-01-26 12:55:13',607),(165,'Concierto de Jazz al Aire Libre','https://ejemplo.com/foto91.jpg',4,'2024-01-26 12:55:13',954),(166,'Mirador al Anochecer','https://ejemplo.com/foto92.jpg',11,'2024-01-26 12:55:13',206),(167,'Festival de Faroles','https://ejemplo.com/foto93.jpg',12,'2024-01-26 12:55:13',653),(168,'Cena Romántica en la Playa','https://ejemplo.com/foto94.jpg',13,'2024-01-26 12:55:13',780),(169,'Cosecha de Uvas en la Viña','https://ejemplo.com/foto95.jpg',16,'2024-01-26 12:55:13',943),(170,'Retrato con Máscara de Carnaval','https://ejemplo.com/foto96.jpg',19,'2024-01-26 12:55:13',505),(171,'Paseo en Barco al Atardecer','https://ejemplo.com/foto97.jpg',21,'2024-01-26 12:55:13',440),(172,'Escena Invernal','https://ejemplo.com/foto98.jpg',24,'2024-01-26 12:55:13',559),(173,'Retrato en la Feria','https://ejemplo.com/foto99.jpg',27,'2024-01-26 12:55:13',474),(174,'Celebración de Cumpleaños','https://ejemplo.com/foto100.jpg',30,'2024-01-26 12:55:13',567);
...
-- Dump completed on 2024-02-14 20:10:24
